...
if(timesHere>7&&timesHere<11&&localStorage.getItem('devTools')&&!localStorage.getItem('devTold')){
	...
	setTimeout(function(){location='https://jcw87.github.io/c2-sans-fight/index.html';},8400);
}
if(timesHere>10){
    localStorage.removeItem('dogRolled');
    document.getElementById('text').innerHTML="audioElement.";
    if(localStorage.getItem('dogtrolld')&&!localStorage.getItem('rt')){localStorage.setItem('rt','true'); history.pushState({},'','dogtrolld'); document.getElementById('text').innerHTML="Wow. You look pissed. I guess you got dogtrolld!";
